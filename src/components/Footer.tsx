...
export default function Footer() {
  ...
  const productLinks = locale === "es"
    ? [
        { label: t.footer.como_funciona, href: "/es/como-funciona" },
        { label: t.footer.pro, href: "/es/pro" },
        { label: t.footer.descargar, href: "#download-final" },
      ]
    : [
        { label: t.footer.como_funciona, href: "/en/how-it-works" },
        { label: t.footer.pro, href: "/en/pro" },
        { label: t.footer.descargar, href: "#download-final" },
      ];

  const learnLinks = locale === "es"
    ? [
        { label: t.footer.guias, href: "/es/guias" },
        { label: t.footer.faq, href: "/es/faq" },
        { label: t.footer.comparativas, href: "/es/comparativas" },
      ]
    : [
        { label: t.footer.guias, href: "/en/guides" },
        { label: t.footer.faq, href: "/en/faq" },
        { label: t.footer.comparativas, href: "/en/compare" },
      ];
