...
async function input(params: Promise<{ handle: string; slug: string }>) { const value = await params; return { locale: "en" as const, objectType: "week" as const, handle: value.handle, slug: value.slug }; }
