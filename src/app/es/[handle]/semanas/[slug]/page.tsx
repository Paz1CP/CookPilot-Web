...
async function input(params: Promise<{ handle: string; slug: string }>) { const value = await params; return { locale: "es" as const, objectType: "week" as const, handle: value.handle, slug: value.slug }; }
